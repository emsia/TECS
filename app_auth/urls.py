...
urlpatterns = patterns('',
	...
	url(r'^activate/(?P<id>\w{32})/$', views.activate, name='activate'),
	...
	url(r'^superadmin/view/details/(?P<username>\w+)$', views.suadmin_viewsuperadmindetails,  name='suadmin_viewsuperadmindetails'),
